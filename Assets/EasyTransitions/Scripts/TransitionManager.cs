...
namespace EasyTransition
{
    ...
    {        
        ...
        /// </summary>
        /// <param name="DiagonalRectangleGrid">The settings of the transition you want to use.</param>
        ...
        /// </summary>
        /// <param name="Level_2">The name of the scene you want to load.</param>
        /// <param name="DiangonalRectangleGrid">The settings of the transition you want to use to load you new scene.</param>
        /// <param name="startDelay">The delay before the transition starts.</param>
