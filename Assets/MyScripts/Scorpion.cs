...
public class Scorpion : MonoBehaviour, IDamageable
{
    ...
    public float dashSpeed = 12f;      // faster dash for aggressive attack
    ...
    IEnumerator DashAttack()
    {
        ...
        // Dash movement toward the player
        ...
        foreach (Collider2D col in hits)
        {
            ...
            if (playerHealth != null)
                playerHealth.TakeDamage(10, transform);
        }
